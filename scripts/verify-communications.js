...
async function main() {
    ...
    const listHandler = require(path.join(ROOT, "api", "_lib", "routes", "leads", "[id]", "communications", "index.js"));
    const singleHandler = require(path.join(ROOT, "api", "_lib", "routes", "leads", "[id]", "communications", "[communicationId]", "index.js"));
    ...
    await test("STRUCTURAL: no reference to Amber anywhere in the routes (comments excluded)", () => {
        ...
        const files = [
            path.join(ROOT, "api", "_lib", "routes", "leads", "[id]", "communications", "index.js"),
            path.join(ROOT, "api", "_lib", "routes", "leads", "[id]", "communications", "[communicationId]", "index.js"),
        ];

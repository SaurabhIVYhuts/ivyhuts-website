...
const { parseJsonBody, ApiError } = require("./_lib/validation");
const { validatePlannerPayload, assertPayloadSize, MAX_PAYLOAD_BYTES } = require("./_lib/pptValidation");
const { normalizePlannerForPresentation } = require("./_lib/pptNormalize");
const { generateStudentPlanPptxBuffer } = require("./_lib/pptBuilder");
